export const userInfo = {
    heading: 'I&#39;m a Software Engineer based in India, with a passion for creating elegant and efficient solutions that seamlessly integrate user-friendly experiences. I&#39;ve built websites, and corporate software, leveraging cutting-edge technologies to drive innovation and enhance business processes.',
    about: `
        <p>👨💻 With 1.5 years in the Software Engineering realm, I'm a dedicated Software Engineer at Magic Edtech. My journey has been defined by a passion for coding, innovation, and continuous learning.
        🔧 Proficient in JavaScript, React, Redux, Next.js. I've been deeply involved in crafting interactive and dynamic user experiences.</p>
        ...
        `,
    skills: ['React.js', 'Next.js', 'Redux', 'HTML', 'CSS', 'Java script', 'Data Structure', 'Java',],
}
